...
public class StringManipulations03 {
    public static void main(String[] args) {
     ...
     int num0fAllChar = str.length();
     int num0fAllCharsDiffFromPunctuationMarks = str.replaceAll("\\p{Punct}","").length();
        System.out.println(num0fAllChar - num0fAllCharsDiffFromPunctuationMarks);//6
        ...
        String fixedFullName = fullName.trim();//trim() method removes spaces from the beginning and from the end,
