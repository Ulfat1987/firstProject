...
public class AnimalRunner {
    ...
    2)To make a class can use class members from the parent classes.
    ...
    5)Inheritance Types in Java
      ...
      3)Multilevel Inheritance (Java does not support it)
      4)Opposite of "Multilevel Inheritance" is "Single Inheritance"
