...
public class Arrays01 {
    ...
    in them.Sometimes we need to store multiple values in a single container.
    ...
    public static void main(String[] args) {
        ...
        //How to print a specific element in a Array
        System.out.println(names[3]);

        //Example 1:Create an integer array and print the sum of the and the last elements on the console.
        int ages[] = new int[9];
        ...
        ages[7] = 20;
        ages[8] = 10;
        System.out.println(Arrays.toString(ages));//[12, 23, 25, 14, 17, 12, 14, 20, 10] and 22 mean 10+12 first+last
        System.out.println(ages[0] + ages[ages.length-1]);

        //Example 2:Create a double array and find the sum fof all elements in the array
        ...
        System.out.println(summy);//13.01
    }
}
