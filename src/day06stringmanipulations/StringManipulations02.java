...
public class StringManipulations02 {
    public static void main(String[] args) {
        ...
        // Here have two option first-order number,second is index number.
        ...
        System.out.println(idx+1);//13 this is order number,if you take +1 out it should be index number 12.
        ...
        //Note 1: indexOf() method can be used with "char" and "String" data types like str.indexOf('a');
        // and like s.indexOf("Java");
        ...
        //2.Way:We use turner
        String res = m.indexOf('l')==-1 ? "The character does not exist" : (m.indexOf('l')==m.lastIndexOf('l') ?
                "The character is unique" : "The character is not unique");
