...
public class StringBuilder02 {
    ...
    public static void main(String[] args) {
        ...
        //Note: When you use a method for StringBuilders, if it is "bold" and "not coming from String Class"
        ...
        //replace(starting index, ending index, new value) is used to change characters from "starting index"
        // to "ending index" to a new value
        //"starting index" is inclusive, "ending index" is exclusive
        sb1.replace(2, 4, "IS");
        System.out.println(sb1);//ppISsiM

        //insert(number of characters from the beginning, new value) method will insert "new value" after
        // skipping "number of characters from the beginning"
        sb1.insert(3, "xxx");
