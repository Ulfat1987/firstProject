...
public class HashMap01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(stdAges);//{null=23, Tom Hanks=46, Brad Pit=55, Cuneyt Arkin=44, Someone Unknown=null,
                                    // Angelina Julie=23, Ajda Pekkan=null, Ali Can=13}
        //How to update the value of a key
        stdAges.replace("Tom Hanks", 56);
        System.out.println(stdAges);//{null=23, Tom Hanks=56, Brad Pit=55, Cuneyt Arkin=44, Someone Unknown=null,
                                    // Angelina Julie=23, Ajda Pekkan=null, Ali Can=13}
        //How to update the value of a key after checking key and the existing value
        stdAges.replace("Tom Hanks", 56, 66);
        System.out.println(stdAges);//{null=23, Tom Hanks=66, Brad Pit=55, Cuneyt Arkin=44, Someone Unknown=null,
                                    // Angelina Julie=23, Ajda Pekkan=null, Ali Can=13}
